...
CurrentWeeklyData = CurrentWeeklyData.reset_index(drop=True)
...
style_df = (CurrentWeeklyData.style.apply(highlight_hr_val, axis=1))

style_df = style_df[['Week', 'Team', 'Opponent', 'HR_val']]
